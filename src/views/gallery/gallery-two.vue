...
export default {
  ...
  data() {
    return {
      galleryItems: [
        { src: "/public/event2/e1.mp4", isVideo: true },
        { src: "/public/event2/e2.mp4", isVideo: true },
        { src: "/public/event2/e3.mp4", isVideo: true },
        { src: "/public/event2/e4.mp4", isVideo: true },

        { src: "/public/event2/e5.jpg", isVideo: false },
                { src: "/public/event2/e6.jpg", isVideo: false },
               { src: "/public/event2/e7.jpg", isVideo: false },
                { src: "/public/event2/e8.jpg", isVideo: false },
                 { src: "/public/event2/e9.jpg", isVideo: false },
                  { src: "/public/event2/e10.jpg", isVideo: false },
                   { src: "/public/event2/e11.jpg", isVideo: false },
