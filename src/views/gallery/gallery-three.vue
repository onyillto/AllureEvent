...
export default {
  ...
  data() {
    return {
      galleryItems: [
        { src: "/public/event3/e1.mp4", isVideo: true },
        { src: "/public/event3/e2.mp4", isVideo: true },
        { src: "/public/event3/e3.jpg", isVideo: false },
        { src: "/public/event3/e4.jpg", isVideo: false },

        { src: "/public/event3/e5.jpg", isVideo: false },
                { src: "/public/event3/e6.jpg", isVideo: false },
               { src: "/public/event3/e7.jpg", isVideo: false },
                { src: "/public/event3/e8.jpg", isVideo: false },
