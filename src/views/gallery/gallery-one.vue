...
export default {
  ...
  data() {
    return {
      galleryItems: [
        { src: "/public/event1/e1.mp4", isVideo: true },
        { src: "/public/event1/e2.mp4", isVideo: true },
        { src: "/public/event1/e3.mp4", isVideo: true },
        { src: "/public/event1/e4.mp4", isVideo: true },

        { src: "/public/event1/e5.jpg", isVideo: false },
                { src: "/public/event1/e6.jpg", isVideo: false },
               { src: "/public/event1/e7.jpg", isVideo: false },
